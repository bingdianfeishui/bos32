...
public class CustomerService implements ICustomerService {
        ...
        List<Customer> list = jdbcTemplate.query(sql,
                new RowMapper<Customer>() {
                    ...
                    public Customer mapRow(ResultSet rs, int rowNum)
                        ...
                        return new Customer(id, name, station, telephone,
                                address, decidedZoneId);
                    }
                });
        return list;
    }
    ...
    @Override
    public Integer findDecidedZoneIdByAddress(String address) {
        String sql = "SELECT decidedzone_id FROM t_customer WHERE address=?";
        Integer decidedZoneId = jdbcTemplate.queryForObject(sql, Integer.class, address);
        return decidedZoneId;
    }

    // public static void main(String[] args){
    // ClassPathXmlApplicationContext context = new
    // ClassPathXmlApplicationContext("classpath:cxf.xml");
